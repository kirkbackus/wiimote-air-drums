...
SM_EXPORT double GetBalanceBoardRawLTR(double wiimote);
SM_EXPORT double GetBalanceBoardRawLTL(double wiimote);
SM_EXPORT double GetBalanceBoardRawLBR(double wiimote);
SM_EXPORT double GetBalanceBoardRawLBL(double wiimote);
SM_EXPORT double GetBalanceBoardRawRTR(double wiimote);
SM_EXPORT double GetBalanceBoardRawRTL(double wiimote);
SM_EXPORT double GetBalanceBoardRawRBR(double wiimote);
SM_EXPORT double GetBalanceBoardRawRBL(double wiimote);

SM_EXPORT double SetWiimoteBoard(double wiimote);
